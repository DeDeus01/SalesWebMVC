...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            {
                Console.WriteLine(" O banco de dados ja está populado!");
                return;
            }
            ...
            Seller s1 = new Seller(1, "Bob Brow", "bob@bol.com", new DateTime(2000, 9, 25), 1000.0, d1);
            Seller s2 = new Seller(2, "Marck Fit", "marck@bol.com", new DateTime(2001, 4, 21), 1000.0, d2);
            Seller s3 = new Seller(3, "Bob Birs", "birs@bol.com", new DateTime(1999, 6, 12), 1000.0, d1);
            Seller s4 = new Seller(4, "Cat Brow", "cat@bol.com", new DateTime(1995, 2, 01), 1000.0, d3);
            Seller s5 = new Seller(5, "Meg isr", "meg@bol.com", new DateTime(1993, 3, 15), 1000.0, d4);
            Seller s6 = new Seller(6, "Tom Brl", "tom@bol.com", new DateTime(2001, 8, 19), 1000.0, d2);
            ...
            _context.Department.AddRange(d1, d2, d3, d4);
                                                                    //AddRange() insere todos os objetos no banco.
